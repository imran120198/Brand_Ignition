...
import Img from "../../../Assets/Imran_khan.jpg";
import {
  useAnimatedLetters,
  AnimatedLetters,
        ...
        <div className="flex flex-col gap-5 text-white opacity-90 md:w-4/6">
          <div data-aos="fade-right">
            <p className="relative">
              Hi, I'm <span className="text-blue-500">Imran Khan</span>, a{" "}
              <span>Full Stack Web Developer</span> with a passion for creating fully
          ...
          <div data-aos="fade-right">
            <p className="relative">
              ...
              <Link to="projects" className="text-blue-500 underline cursor-pointer">
                here
              </Link>
